...
main() {
    ...
    sshpass -p "ftedev!@#" scp -r -J ftedev@149.129.219.106 ./k8s-template ftedev@172.31.123.0:~/.templates || handle_exception "Failed to copy the file"
    sshpass -p "ftedev!@#" scp -r -J ftedev@149.129.219.106 ./k8s-template-vault ftedev@172.31.123.0:~/.templates || handle_exception "Failed to copy the file"
    sshpass -p "ftedev!@#" scp -r -J ftedev@149.129.219.106 ./k8s-template-beta-prod ftedev@172.31.123.0:~/.templates || handle_exception "Failed to copy the file"
    sshpass -p "ftedev!@#" scp -r -J ftedev@149.129.219.106 ./k8s-template-vault-beta-prod ftedev@172.31.123.0:~/.templates || handle_exception "Failed to copy the file"
    ...
    sshpass -p "ftedev!@#" scp -r -J ftedev@149.129.219.106 ./README.md ftedev@172.31.123.0:~/.templates || handle_exception "Failed to copy the file"
